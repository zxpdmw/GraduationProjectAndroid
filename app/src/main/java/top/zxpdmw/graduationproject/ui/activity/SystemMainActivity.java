...
import top.zxpdmw.graduationproject.presenter.MainPresenter;
...
public class SystemMainActivity extends AppCompatActivity implements AdapterView.OnItemClickListener, MainContract.View {
    ...
    @Override
    public void showMsg(String mgs) {
    }
}
